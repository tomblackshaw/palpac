...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 60, 508, 194))
        self.layoutWidget.setObjectName("layoutWidget")
        self.a_horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.a_horizontalLayout.setContentsMargins(0, 0, 0, 0)
        ...
        self.frame.setGeometry(QtCore.QRect(-10, 280, 703, 46))
