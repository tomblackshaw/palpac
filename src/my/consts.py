...
hello_owner_lst = [
"""{owner}. {owner}? {owner} {owner} {owner}! Ugh. Hey! Good ${morning_or_afternoon_or_evening}""".replace('{owner}', OWNER_NAME),
"""Good ${morning_or_afternoon_or_evening}, {owner}""".replace('{owner}', OWNER_NAME),
"""Hey yoe, {owner}! Good ${morning_or_afternoon_or_evening}""".replace('{owner}', OWNER_NAME),
...
"""Hey, {owner}! Check it""".replace('{owner}', OWNER_NAME),
]
...
"""Like, Oh Em Gee, you are totes late, {owner}. JK, it's ${shorttime} and POV your drip is straight fire. Or gay fire. Whatevs. Anyway, time to rise and shine, my short boss sigma!""".replace('{owner}', OWNER_NAME),
