...
class StolenSlider(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        super(StolenSlider, self).__init__(parent)
    ...
    def __get_position_x_from_value(self, value):
    ...
    def __format_value(self, value, is_float: bool, decimals: int,
                       thousands_separator: str, decimal_separator: str):
    ...
    def __round_cast_value(self, value):
